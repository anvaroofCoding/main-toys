						...
						<>
							...
							<div className='pt-4 flex flex-col gap-3 text-white'>
								<button
									...
									className='flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-xl text-sm font-medium shadow transition-all'
								>
									<Edit3 size={16} />
									Tahrirlash
								</button>
