...
export default function ProductDetails() {
  ...
  const handleNumericInputSubmit = () => {
    ...
    if (!inputValue || isNaN(numValue) || numValue < 1) {
      toast.error("Iltimos, to`g`ri raqam kiriting");
      return;
    }
    ...
    if (numValue > maxQuantity) {
      toast.error(
        `Maksimal miqdor: ${maxQuantity} dona. Bu rangdagi mahsulot soni tugagan!`
      );
      return;
    }
    ...
    toast.success(`Miqdor ${numValue} ga o'rnatildi`);
  };
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 ">
              ...
              <Button
                ...
                variant="outline"
                className="h-14 px-6 rounded-xl font-semibold bg-blue-500/10  border-blue-500"
                style={{ color: "#2B7FFF" }}
              >
                Ko'p buyurtma
              </Button>
      ...
      {showNumericInput && (
        <div className="fixed inset-0 z-100 flex items-end bg-black/50 animate-in fade-in">
          <div className="w-full bg-background rounded-t-2xl shadow-lg animate-in slide-in-from-bottom-5 duration-300">
            <div className="sticky top-0 flex items-center justify-between p-4 border-b">
              <h3 className="font-semibold text-lg">Miqdorni kiriting</h3>
              <Button
                variant="ghost"
                size="icon"
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-muted/50 p-4 rounded-xl text-center">
                ...
                <div className="text-4xl font-bold text-blue-500 min-h-12 flex items-center justify-center">
                  {inputValue || "0"}
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((num) => (
                  <Button
                    key={num}
                    onClick={() => handleNumericKeyPress(num.toString())}
                    style={{ color: "white" }}
                    className="h-16 text-2xl font-semibold bg-blue-500  hover:bg-blue-400 hover:text-white text-blue-500 rounded-xl border border-blue-500/20 transition-all"
                  >
                    {num}
                  </Button>
                ))}
                <Button
                  ...
                  className="col-span-2 h-16 text-2xl font-semibold bg-blue-500  hover:bg-blue-400 hover:text-white text-blue-500 rounded-xl border border-blue-500/20 transition-all"
                  style={{ color: "white" }}
                >
                  0
                </Button>
                <Button
                  ...
                  style={{ color: "white" }}
                  className="h-16 text-xl font-semibold hover:text-white text-red-500 rounded-xl border border-red-500/20 transition-all bg-red-400 hover:bg-red-300"
                  title="Backspace"
                >
                  ←
                </Button>
              ...
              <div className="flex gap-3 pt-2">
                <Button
                  ...
                  variant="outline"
                  style={{ color: "white" }}
                  className="flex-1 h-12 rounded-xl font-semibold bg-red-400 hover:bg-red-300"
                >
                  Bekor qilish
                </Button>
                <Button
                  onClick={handleNumericInputSubmit}
                  disabled={!inputValue}
